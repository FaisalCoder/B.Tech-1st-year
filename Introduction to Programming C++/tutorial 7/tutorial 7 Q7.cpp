...
int main()
{
  ...
  // ifstream state_table;
 //  state_table.open("state_table.txt");
   ...
   state_table[0][0] = '-';   // dirst one is default
  //input values
   ...
   while( i2 < input_string.length() )
   {
      ...
      if ( accept ) cout << " which is accepting state" << endl;
